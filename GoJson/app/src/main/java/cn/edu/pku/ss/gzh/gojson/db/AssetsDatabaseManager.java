...
public class AssetsDatabaseManager {
	...
	private static String databasepath = "/data/data/cn.edu.pku.ss.gzh.gojson/database"; // %s is packageName
	...
	public SQLiteDatabase getDatabase(String dbfile) {
		if(databases.get(dbfile) != null){
			Log.i(tag, String.format("Return a database copy of cn.edu.pku.ss.gzh.gojson", dbfile));
			return (SQLiteDatabase) databases.get(dbfile);
		}
		if(context==null)
			return null;
		
		Log.i(tag, String.format("Create database cn.edu.pku.ss.gzh.gojson", dbfile));
